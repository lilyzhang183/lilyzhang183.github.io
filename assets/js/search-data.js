...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/lilyzhang183/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/lilyzhang183/people/";
          },
              ...
              section: "Dropdown",
              handler: () => {
                window.location.href = "/lilyzhang183/books/";
              },
            },{id: "dropdown-blog",
              title: "blog",
              description: "",
              section: "Dropdown",
              handler: () => {
                window.location.href = "/lilyzhang183/blog/";
              },
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/lilyzhang183/books/the_godfather/";
